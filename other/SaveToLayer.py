# -*- coding: utf-8 -*-
"""
Generated by ArcGIS ModelBuilder on : 2024-10-14 14:01:30
"""
import arcpy
...
def Model():  # Model
    ...
    cancer_tracts_OG_2_ = arcpy.management.AddJoin(in_layer_or_view=cancer_tracts_OG_3_, in_field="GEOID10", join_table=CancerZonalStats, join_field="CANCER_TRACTS_OG")[0]
    ...
    arcpy.management.SaveToLayerFile(in_layer=IDW_Raster, out_layer=IDW_LayerFile_lyrx)
